''' A decimal number can be represented as a sequen e of bits: To illustrate:
        6 = 00000110
        23 = 00010111

    From teh bitwise representation of numbers, we can calculate the bitwise AND,
    ...
    Write three functions to calculate the bitwise AND, bitwise OR and bitwise
    XOR of two numbers.'''
